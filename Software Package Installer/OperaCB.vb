...
Public Class OperaCB
    ...
    Private Sub OperaCB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_32f66a0f56b945fd8e139d7cde1d53e0.zip"), Texbbb.TextBox34.Text)
        Timer1.Start()
