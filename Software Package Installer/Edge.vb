...
Public Class Edge
    ...
    Private Sub Edge_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_61bee8fdd8224779966180694aff9c75.zip"), Texbbb.TextBox4.Text)
