...
Public Class Crystaldiskinfo
    ...
    Private Sub Crystaldiskinfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_3fd92201ae934eb39a4d746723ea25ca.zip"), Texbbb.TextBox48.Text)
