...
Public Class Visual
    ...
    Private Sub Vsc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ProgressBar1.Show()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_5b2bcd7fc1bf4ab380311443e4d4bbcb.zip"), Texbbb.TextBox1.Text)
        Timer1.start
    End Sub
