...
Public Class Vivaldi
    ...
    Private Sub Vivaldi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_fb95a19947b241829e15d35a45892fc2.zip"), Texbbb.TextBox33.Text)
